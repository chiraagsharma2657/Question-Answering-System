...
def predict(examples, all_features, all_results, max_answer_length):
    ...
    for example in examples:
        ...
        all_predictions[example] = nbest_json[0]
        index=+1
...
def main(paragraph ,questions , model = "model2/pytorch_model.bin" , max_seq_length = 384 ,doc_stride = 128,max_query_length=64 ,config_file = "Results/bert_config.json" , max_answer_length = 30  ):
